...
namespace ClubMembershipApplication.FieldValidators
{
    ...
    public class UserRagistrationValidator : IFieldValidator
    {
        ...
        public UserRagistrationValidator(IRegister register)
        {
                _register = register;
        }

        public string[] fieldArray => null;

        public FieldValidatorDel ValidatorDel => _fieldValidatorDel;

        public void InitialiseValidatorDel()
        {
            ...
            _stringLengthValidDel = CommonFieldValidatorFunctions._stringLengthValidDel;
        ...
        private bool ValidField(int fieldIndex, string fieldValue, string[] fieldArray,out string fieldInvalidMessage)
        {
            ...
            switch(userRegistrationField)
            {
                case FieldConstants.UserRegistrationField.EmailAddress:
                    ...
                    fieldInvalidMessage = (fieldInvalidMessage == "" && _emailExistDel(fieldValue)) ? $"This email address already exists. Please try again{Environment.NewLine}" : fieldInvalidMessage;
